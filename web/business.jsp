                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <ul class="nav nav-tabs topnav" id="myTab">
                                                    ...
                                                    <li><a data-toggle="tab" href="#brand" class="active">Brand</a></li>
                                                    <li><a data-toggle="tab" href="#outlet">Outlet</a></li>
                                                </ul>
                                            </div>
                                            <div class="row">
                                                            ...
                                                            <div id="account_body" class="tab-content" style="width: 100%">
                                                                <div id="account_right">
                                                                    <div id="account_biodata">
                                                                        Brand Profile<br><br>
                                                                        <label style="color: #CCC; font-size: 16px; font-weight: 400;">Brand ID</label>
                                                                        <input disabled="" type="text" id="brand_id" readonly=""><br>
                                                                        <label style="color: #CCC; font-size: 16px; font-weight: 400;">Brand Name</label>
                                ...
                                for (let element of data) {
                                    ...
                                    for (key in element) {
                                        if (i == 0) {
                                            ...
                                            var gg = 10000;
                                            var jj = element[key];
                                            let text = document.createTextNode(numberWithCommas(element[key]));
                                            cell.id = "balance";
                                            cell.style.cursor = "pointer";
                                            cell.appendChild(text);
                                        }
