 ...
 * @author suhanda
 */
public class AddOutletServlet extends HttpServlet {

    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(AddOutletServlet.class);

    public AddOutletServlet() {
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.add_outlet);
