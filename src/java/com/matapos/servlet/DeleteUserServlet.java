...
public class DeleteUserServlet extends HttpServlet {
    ...
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(DeleteUserServlet.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String user_id = newJson.get("user_id_edit_user").toString();
            String outlet_id = newJson.get("outlet_id_edit_user").toString();

            req.put(FieldParameterMatapos.proccode, ProcessingCode.delete_user);
