...
public class IncomeList extends HttpServlet {
    ...
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(IncomeList.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.income_list);
            ...
            response.getWriter().print(resp.get(FieldParameterMatapos.income_list));
        } catch (Exception e) {
