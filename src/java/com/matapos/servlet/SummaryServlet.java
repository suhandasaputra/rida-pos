...
public class SummaryServlet extends HttpServlet {
    ...
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(SummaryServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.getsummaryinventory);
            ...
            response.getWriter().print(resp.get(FieldParameterMatapos.listsummaryproduct));
        } catch (Exception e) {
