...
public class AddSupplierServlet extends HttpServlet {
    ...
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(AddSupplierServlet.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.addsupplier);
