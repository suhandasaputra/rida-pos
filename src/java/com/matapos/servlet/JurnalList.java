 ...
 * @author suhanda
 */
public class JurnalList extends HttpServlet {

    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(JurnalList.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.jurnal_list);
            ...
            response.getWriter().print(resp.get("jurnal_list"));
        } catch (IOException e) {
