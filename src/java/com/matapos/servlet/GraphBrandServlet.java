 ...
 * @author suhanda
 */
public class GraphBrandServlet extends HttpServlet {

    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(GraphBrandServlet.class);

    public GraphBrandServlet() {
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.brand_grap);
