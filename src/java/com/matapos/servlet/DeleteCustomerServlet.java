...
public class DeleteCustomerServlet extends HttpServlet {
    ...
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(DeleteCustomerServlet.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            req.put(FieldParameterMatapos.proccode, ProcessingCode.delete_customer);
            req.put(FieldParameterMatapos.brand_id, brand_id);
            req.put(FieldParameterMatapos.customer_email, email);
